...
graph.add("Tokyo");
graph.add("Aspen");
graph.add("Los Angeles");
graph.add("Hong Kong");

graph.connect("Dallas", "Tokyo");
graph.connect("Dallas", "Aspen");
graph.connect("Hong Kong", "Tokyo");
graph.connect("Hong Kong", "Dallas");
graph.connect("Los Angeles", "Hong Kong");
graph.connect("Los Angeles", "Aspen");

graph.display();

graph.remove("Hong Kong");
graph.display();
